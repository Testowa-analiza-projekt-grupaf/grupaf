...
=======
```{r}
# TU JEST PROBLEM Z OPISAMI
>>>>>>> 69bc84c26d12c32aad570688205f11b35ee7ed60
...
```
###P-value wynosi 0,45, więc zmienna "Ilość posiadanych kredytów w tym banku" nie jest istotna, co widać na wykresach: możemy zaobserwowac, że zdlonośc kredytowa we wszystkich czterech przypadkach znajduje się na bardzo zbliżonym poziomie.
