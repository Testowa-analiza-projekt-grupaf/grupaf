...
Na wykresie zależności zdolności kredytowej od stanu konta bankowego można zobaczyć nieoczywiste wyniki, ponieważ na wykres miała wpływ nie tylko jedna zmienna, a więcej. Według wyników z wykresu widać, że stan konta bankowego nie ma istotnego znaczenia co do zdolności kredytowej.
...
Na wykresie wyżej również pozostałe zmienne wpływają na wyniki. Zależność zdolności kredytowej od stażu pracy nie jest współmiernie rosnąca.
...
W tym wypadku najwięcej klientów ma zdolność kedytową wtedy ,gdy spłaty kredytu są terminowe, ale według wykresu również gdy konto jest krytyczne, czyli wtedy gdy klient ma zoobowiązanie jeszcze w innym banku.
...
Najwięcej klientów ma zdolność kredytową przy jednym kreddycie. Im większa ilość kredytów tym mniejsza ilość klientów. Przy 4 zaciągnietych kredytach ilość klientów jest praktycznie zerowa.
...
Największa zdolność kredytowa jest między 25, a 45 rokiem życia. Od ok. 40 roku życia spada, z małymi odbiciami i jednym większy odbiciem około roku 65.
...
W tej tabeli mamy porównanie dobrego i złego klienta według ich cech. Dobry klientem jest ten, który wiekiem sięga do 55 roku życia i liczba zaciągniętych kredytów nie przekracza 2. Jego środki na koncie są równe, bądź 200 przekraczają niemieckich marek. Również świadczy o tym jego zatrudnnie, które powinno być większę lub równe 3, co pokazuje jegop doświdcxzenie zawodowe. Pozytywną cechą są nie zaciągane wcześniej kredyty lub terminowe spłaty ich. Złym klientem jest osoba  starsza niż 55 lat, co też udowadnia nam poprzedni wykres. Również większa ilość zaciągnietych kredytów jest negatywna i ujemne środki na koncie. 
...
Najbardziej widoczny jest punkt Credit_Amount/Duration_of_credit co oznacza, że najbardziej skorelowana jest kwota kredytu z czasem kredytu. Następnie troche mniejsza korelacja Credits_at_this_Bank/Previous_Credit, co oznacza skorelowanie kredytów w tym banku z poprzednimi. Kolorem pomarańczowym jest ukazana ujemna korelacja i widać ją najlepiej między Instalment_rate/Credit_Amount.
...
```
P-value wynosi 0,45, więc zmienna "Ilość posiadanych kredytów w tym banku" nie jest istotna, co widać na wykresach: możemy zaobserwować, że zdloność kredytowa we wszystkich czterech przypadkach znajduje się na bardzo zbliżonym poziomie.
