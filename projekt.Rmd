...
Natomiast złym klientem jest osoba w wieku wyższym niż 55 lat, ilość zaciągnietych kredytów przez którą przewyższa dwa, która posiada brak środków na koncie, pracowała mniej niż 3 lata oraz miała wcześniej zaciągnięte kredyty, które nie zostały spłacone w terminie, lub posiada konto krytyczne.  
...
```
Na wykresie 10 widzimy, że liczba przepracownaych lat istotnie wpływa na ryzyko kredytowe.
